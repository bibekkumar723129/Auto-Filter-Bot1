...
Contact to the admin @Darkworld008 
...
©️ Powered by: <b>{message.chat.title}</b>"""
    ...
    FILE_CAPTION = """<i>@UniformMovies{file_name}</i>
...
- ꜱᴏᴜʀᴄᴇ - <a href=https://t.me/darkworld008>ʜᴇʀᴇ</a>

- ᴅᴇᴠʟᴏᴘᴇʀ - @darkworld008"""
